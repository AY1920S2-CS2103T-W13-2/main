...
public class AddGuestCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withTags(VALID_TAG).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB
                + PERSON_ID_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + TAG_DESC_FRIEND, new AddGuestCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PERSON_ID_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PERSON_ID_DESC_BOB
                ...
                + EMAIL_DESC_BOB + TAG_DESC_FRIEND, new AddGuestCommand(expectedPerson));
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PERSON_ID_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, new AddGuestCommand(expectedPersonMultipleTags));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + PERSON_ID_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB ,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, NAME_DESC_BOB + PERSON_ID_DESC_BOB
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PERSON_ID_BOB
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + PERSON_ID_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PERSON_ID_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_TAG_DESC + VALID_TAG, Tag.MESSAGE_CONSTRAINTS);
