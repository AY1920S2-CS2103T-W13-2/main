...
Examples:
* `addguest n/John Doe i/G1231231X p/1928310 e/johndoe@gmail.com t/Member`
Add John Doe with his information into the database and sets his status to `Member`.

* `addguest n/Sallly Smith i/G1231232X p/512685123 e/sallysmith@gmail.com t/VIP`
Add Sally Smith with her information into the database and sets her status to `VIP`.
//end::addguest[]
...
* *Help* : `help`
* *Add Guest* : `addguest n/NAME i/ID p/PHONE_NUMBER e/EMAIL t/TAG` +
e.g. `addguest n/John Doe i/G1231231X p/1928310 e/johndoe@gmail.com t/Member`
